      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" type="button" data-toggle="modal" data-target="#exampleModal" href="#">Agregar recibo</a>
            <a class="collapse-item" type="button" data-toggle="modal" data-target="#exampleModal2" href="#">Editar datos</a>
            <a class="collapse-item" type="button" data-toggle="modal" data-target="#exampleModal3" href="#">Agregar empleado</a>
            <a class="collapse-item" type="button" data-toggle="modal" data-target="#exampleModal4" href="#">Eliminar empleado</a>
          </div>
        </div>
      </li>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <input type="submit" class="btn btn-secondary" data-dismiss="modal" value="Cerrar">
    ...
    <div class="modal fade" id="exampleModal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Últimos movimientos</h6>
